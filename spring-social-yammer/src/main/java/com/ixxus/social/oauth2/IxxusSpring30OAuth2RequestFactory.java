...
public class IxxusSpring30OAuth2RequestFactory implements ClientHttpRequestFactory {
    ...
    public IxxusSpring30OAuth2RequestFactory(ClientHttpRequestFactory delegate, String accessToken, OAuth2Version oauth2Version) {
    ...
    private static class OAuth2SigningRequest implements ClientHttpRequest {
        ...
        /**
         * Added by Ixxus to fix the issue with the capitalisation of Bearer
         * 
         * @return
         */
        private String getAuthorizationHeaderValue() {
            if (OAuth2Version.BEARER.equals(oauth2Version)) {
                return "Bearer " + accessToken;
            } else {
                return oauth2Version.getAuthorizationHeaderValue(accessToken);
            }
        }
